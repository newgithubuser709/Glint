...
// ______________TRASITION SCROLL TO ELEMENT FUNCTION SCRIPT [START]_____________________________________[8]

var footer_active_year = document.getElementById("footer_active_year");

let date = new Date();
let active_date = date.getFullYear()

footer_active_year.innerText = active_date
console.log(date);